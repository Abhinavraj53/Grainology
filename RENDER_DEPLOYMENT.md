...
## Backend URL
**Production Backend**: https://grainology.onrender.com
...
2. **CORS**: 
   - The backend is configured to accept requests from `https://rareus.store/`
   - Update `FRONTEND_URL` if your frontend domain changes

3. **Health Check**:
   - Test your deployment: `https://grainology.onrender.com/health`
...
curl https://grainology.onrender.com/health

# Test API endpoint
curl https://grainology.onrender.com/api/auth/session
```
