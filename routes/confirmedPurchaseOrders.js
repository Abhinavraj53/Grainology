    ...
    for (let i = 0; i < records.length; i++) {
      ...
      try {
        ...
        const orderData = {
          ...
          supplier_name: record.supplier_name || record['Supplier Name'] || record['Supplier'] || '',
          ...
          bddi: parseFloat(record.bddi || record['BDDI'] || 0),
          excess_bddi: parseFloat(record.excess_bddi || record['Excess BDDI'] || 0),
          moi_bddi: parseFloat(record.moi_bddi || record['MOI+BDDI'] || 0),
          weight_deduction_kg: parseFloat(record.weight_deduction_kg || record['Weight Deduction (KG)'] || 0),
          deduction_amount_moi_bddi: parseFloat(record.deduction_amount_moi_bddi || record['Deduction Amount MOI+BDDI'] || 0),
          other_deductions: [],
          quality_report: {},
